...
export const registerSuccess = (data: { doctor: Doctor; token: string }): RegisterSuccessAction => ({
...
export const loginSuccess = (data: { doctor: Doctor; token: string }): LoginSuccessAction => ({
    type: LOGIN_SUCCESS,
    payload: data
});
