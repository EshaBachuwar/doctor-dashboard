...
export const fetchPatientsSuccess = (patients: Patient[]): FetchPatientsSuccessAction => ({
...
export const addPatientSuccess = (patient: Patient): AddPatientSuccessAction => ({
...
export const updatePatientSuccess = (patient: Patient): UpdatePatientSuccessAction => ({
    type: UPDATE_PATIENT_SUCCESS,
    payload: patient
});

export const updatePatientFailure = (error: string): UpdatePatientFailureAction => ({
...
export const deletePatientSuccess = (patientId: string): DeletePatientSuccessAction => ({
    type: DELETE_PATIENT_SUCCESS,
    payload: patientId
});

export const deletePatientFailure = (error: string): DeletePatientFailureAction => ({
