    ...
    <div className={`${
      ...
      <div className="gap-3 m-2">
        ...
        <div className="grid grid-cols-5 gap-4 mt-4">
          <div>
            <label className={`${darkMode?"text-gray-300": "text-gray-600"}`}>Name : </label>
            <span>{selectedPatient?.name}</span>
          </div>
          <div>
            <label className={`${darkMode?"text-gray-300": "text-gray-600"}`}>Age : </label>
            <span>{selectedPatient?.age}</span>
          </div>
          <div>
            <label className={`${darkMode?"text-gray-300": "text-gray-600"}`}>Weight : </label>
            <span>{selectedPatient?.weight}</span>
          </div>
          <div>
            <label className={`${darkMode?"text-gray-300": "text-gray-600"}`}>Gender : </label>
            <span>{selectedPatient?.gender}</span>
          </div>
          <div>
            <label className={`${darkMode?"text-gray-300": "text-gray-600"}`}>Blood Group : </label>
            <span>{selectedPatient?.bloodGroup}</span>
          </div>
        </div>
        <div className="flex justify-between mt-4 mr-8">
          <div>
            <label className={`${darkMode?"text-gray-300": "text-gray-600"}`}>Phone Number : </label>
            <span>{selectedPatient?.phone}</span>
          </div>
          <div>
            <label className={`${darkMode?"text-gray-300": "text-gray-600"}`}>Next Visit : </label>
            <span>{selectedPatient?.nextVisit}</span>
          </div>
        </div>
        <div className=" mt-4">
          <div>
            <label className={`${darkMode?"text-gray-300": "text-gray-600"}`}>Known Allergies : </label>
            <span>{selectedPatient?.knownAllergies}</span>
          </div>
        </div>
        <div className=" mt-4">
          <div>
            <label className={`${darkMode?"text-gray-300": "text-gray-600"}`}>Reason Of Visit : </label>
            <span>{selectedPatient?.reasonOfVisit}</span>
          </div>
        </div>
        <div className=" mt-4">
          <div>
            <label className={`${darkMode?"text-gray-300": "text-gray-600"}`}>Diagosis : </label>
            <span>{selectedPatient?.diagnosis}</span>
          </div>
        </div>
        <div className="mt-4">
          <div>
            <label className={`${darkMode?"text-gray-300": "text-gray-600"}`}>Prescribed Medications : </label>
            <div className="mt-2">
              <Medications
        ...
        <div className=" mt-4">
          <div>
            <label className={`${darkMode?"text-gray-300": "text-gray-600"}`}>Reports : </label>
            <div>
