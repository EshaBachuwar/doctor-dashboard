    ...
    <Page size="A4" style={styles.page}>
      <View style={styles.header}>
        ...
        <Text style={styles.hospitalInfo}>
          Phone: {store.getState().auth.doctor?.phone} • Email:{" "}
          {store.getState().auth.doctor?.email}
        </Text>
        <Text style={styles.doctorInfo}>
          {store.getState().auth.doctor?.name},{" "}
          {store.getState().auth.doctor?.specialization}{" "}
        </Text>
      </View>
        ...
        {patient?.prescribedMedication?.map((med, index) => (
          <View key={index} style={styles.medicationItem}>
            ...
            <View style={styles.timingRow}>
              ...
              <Text
                style={
                  med.timing?.night ? styles.activeTimingBox : styles.timingBox
                }
              >
                Night
              </Text>
